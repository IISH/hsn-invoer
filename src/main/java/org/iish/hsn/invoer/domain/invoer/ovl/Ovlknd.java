...
public class Ovlknd extends Invoer implements Serializable {
    ...
    @Column(name = "BRPOVL", nullable = false, length = 254) private String brpovl = "";
    ...
    @Column(name = "BRPVOVL", nullable = false, length = 254) private String brpvovl  = "";
    ...
    @Column(name = "BRPMOVL", nullable = false, length = 254) private String brpmovl  = "";
