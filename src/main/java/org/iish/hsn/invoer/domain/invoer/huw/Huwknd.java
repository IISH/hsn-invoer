...
public class Huwknd extends Invoer implements Serializable {
    ...
    @Column(name = "BRPHM", nullable = false, length = 254) private String brphm  = "";
    ...
    @Column(name = "BRPHV", nullable = false, length = 254) private  String brphv   = "";
    ...
    @Column(name = "BRPVRHM", nullable = false, length = 254) private String brpvrhm  = "";
    ...
    @Column(name = "BRPMRHM", nullable = false, length = 254) private String brpmrhm  = "";
    ...
    @Column(name = "BRPVRHV", nullable = false, length = 254) private String brpvrhv  = "";
    ...
    @Column(name = "BRPMRHV", nullable = false, length = 254) private String brpmrhv  = "";
